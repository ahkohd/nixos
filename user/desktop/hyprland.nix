...
let
  ...
  display_picture = "~/.avatars/rengoku.jpg";
...
in {
  ...
  wayland.windowManager.hyprland.settings = with default_apps; {
    ...
    bind = [
      ...
      "$hyper, S, resizeactive, 0 10"
      "$hyper, D, resizeactive, 0 -10"
      "$hyper, A, resizeactive, 10 0"
      "$hyper, F, resizeactive, -10 0"
      ...
      "$hyper, Return, movetoworkspace, special"
  ...
  home.file.".avatars/rengoku.jpg".source = ./assets/avatars/rengoku.jpg;
}
