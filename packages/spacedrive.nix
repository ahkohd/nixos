...
let
  ...
  src = builtins.fetchurl {
    url =
      "https://github.com/spacedriveapp/spacedrive/releases/download/${version}/Spacedrive-linux-x86_64.AppImage";
...
in pkgs.appimageTools.wrapType2 {
  ...
  extraPkgs = pkgs:
    (pkgs.appimageTools.defaultFhsEnvArgs.multiPkgs pkgs) ++ [ pkgs.libthai ];
